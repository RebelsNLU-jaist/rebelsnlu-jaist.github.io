...
1. Dang Huu-Tien, Hoang Thanh-Tung, Anh Tuan Bui, Phuong Minh Nguyen, Le-Minh Nguyen, Naoya Inoue. [Improving LLM Unlearning Robustness via Random Perturbations](https://openreview.net/forum?id=QYw192hTdH). In Transactions on Machine Learning Research (TMLR), April 2026.

1. Hakaze Cho, Haolin Yang, Gouki Minegishi, Naoya Inoue. [Mechanism of Task-oriented Information Removal in In-context Learning](https://openreview.net/forum?id=VAv1rrPR1A). In the Fourteenth International Conference on Learning Representations (ICLR), April 2026.

1. Haolin Yang, Hakaze Cho, Naoya Inoue. [Localizing Task Recognition and Task Learning in In-Context Learning via Attention Head Analysis](https://openreview.net/forum?id=gdvOF1OMa7). In the Fourteenth International Conference on Learning Representations (ICLR), April 2026.

1. Haolin Yang, Hakaze Cho, Kaize Ding, Naoya Inoue. [Task Vectors, Learned Not Extracted: Performance Gains and Mechanistic Insight](https://openreview.net/forum?id=RGEbVZgf4E). In the Fourteenth International Conference on Learning Representations (ICLR), April 2026.

1. Phuong Minh Nguyen, Dang Huu-Tien, and Naoya Inoue. [Improving Chain-of-Thought for Logical Reasoning via Attention-Aware Intervention](https://aclanthology.org/2026.findings-eacl.152/). In Findings of the 19th Conference of the European Chapter of the Association for Computational Linguistics (EACL), pp. 2917-2941, 2026.

1. Yuting Shi, Houjing Wei, and Naoya Inoue. [On the Additive Compositionality of Task Vectors in Vision–Language Models](https://aclanthology.org/2026.eacl-short.38/). In Proceedings of the 19th Conference of the European Chapter of the Association for Computational Linguistics (EACL), pp. 513-521, 2026.

1. Ai Ishii, Naoya Inoue, Hisami Suzuki, Satoshi Sekine. [Fine-grained Confidence Estimation for Spurious Correctness Detection in Large Language Models](https://aclanthology.org/2025.ijcnlp-long.68/). In Proceedings of the 14th International Joint Conference on Natural Language Processing and the 4th Conference of the Asia-Pacific Chapter of the Association for Computational Linguistics (IJCNLP-AACL), pp. 1238-1257, December 2025.

1. Surawat Pothong, Machi Shimmei, Naoya Inoue, Paul Reisert, Ana Brassard, Wenzhi Wang, Shoichi Naito, Jungmin Choi, Kentaro Inui. [FOCUS: A Benchmark for Targeted Socratic Question Generation via Source-Span Grounding](https://aclanthology.org/2025.ijcnlp-long.157/). In Proceedings of the 14th International Joint Conference on Natural Language Processing and the 4th Conference of the Asia-Pacific Chapter of the Association for Computational Linguistics (IJCNLP-AACL), pp. 2938-2958, December 2025.

1. Haolin Yang, Hakaze Cho, Yiqiao Zhong, and Naoya Inoue. [Unifying Attention Heads and Task Vectors via Hidden State Geometry in In-Context Learning](https://openreview.net/forum?id=FIfjDqjV0B). In Proceedings of the 39th Conference on Neural Information Processing Systems (NeurIPS), December 2025.

1. Minh-Phuong Nguyen, Tien Dang and Naoya Inoue. [Non-Interactive Symbolic-Aided Chain-of-Thought for Logical Reasoning](https://aclanthology.org/2025.paclic-1.29/). In Proceedings of the 39th Pacific Asia Conference on Language, Information and Computation (PACLIC), pp. 329-340, December 2025.

1. Hakaze Cho, Peng Luo, Mariko Kato, Rin Kaenbyou, Naoya Inoue. [Mechanistic Fine-tuning for In-context Learning](https://aclanthology.org/2025.blackboxnlp-1.21/). In Proceedings of the 8th BlackboxNLP Workshop: Analyzing and Interpreting Neural Networks for NLP (BlackBoxNLP), pp. 330–357, November 2025.

1. Hinata Tezuka, and Naoya Inoue. [The Transfer Neurons Hypothesis: An Underlying Mechanism for Language Latent Space Transitions in Multilingual LLMs](https://aclanthology.org/2025.emnlp-main.1618/). In Proceedings of the 2025 Conference on Empirical Methods in Natural Language Processing (EMNLP), pp. 31742–31792, November 2025.

1. Wenzhi Wang, Paul Reisert, Shoichi Naito, Naoya Inoue, Machi Shimmei, Surawat Pothong, Jungmin Choi, and Kentaro Inui. [Identification of Multiple Logical Interpretations in Counter-Arguments](https://aclanthology.org/2025.emnlp-main.326/). In Proceedings of the 2025 Conference on Empirical Methods in Natural Language Processing (EMNLP), pp. 6418–6433, November 2025.

1. Nguyen Ngoc Minh, Naoya Inoue and Nguyen Le Minh. [Improve Smart Contract Vulnerability Explanation with Synthetic Data and Chain-of-Thought Prompting](https://link.springer.com/chapter/10.1007/978-3-031-97141-9_28). In Proceedings of the 30th International Conference on Natural Language & Information Systems (NLDB), pp. 411—425, July 2025.

1. Taisei Ozaki, Chihiro Nakagawa, Naoya Inoue, Shoichi Naito, and Kenshi Yamaguchi. [LLM DEBATE OPPONENT : Counter-argument Generation focusing on Implicit and Critical Premises](https://aclanthology.org/2025.naacl-srw.44/). In Proceedings of the 2025 NAACL Student Research Workshop (SRW), pp. 456–465, April 2025.

1. Hakaze Cho, Mariko Kato, Yoshihiro Sakai, and Naoya Inoue. [Revisiting In-context Learning Inference Circuit in Large Language Models](https://openreview.net/forum?id=xizpnYNvQq). In the Thirteenth International Conference on Learning Representations (ICLR), April 2025.

1. Hakaze Cho, Yoshihiro Sakai, Mariko Kato, Kenshiro Tanaka, Akira Ishii, and Naoya Inoue. [Token-based Decision Criteria Are Suboptimal in In-context Learning](https://aclanthology.org/2025.naacl-long.278/). In Proceedings of the 2025 Annual Conference of the Nations of the Americas Chapter of the ACL (NAACL), pp. 5378–5401, April 2025.

1. Huu-Tien Dang, Tin Pham, Hoang Thanh-Tung, and Naoya Inoue. [On Effects of Steering Latent Representation for Large Language Model Unlearning](https://ojs.aaai.org/index.php/AAAI/article/view/34544). In Proceedings of the 39th AAAI Conference on Artificial Intelligence (AAAI), February 2025.
...
1. Irfan Robbani, Paul Reisert, Surawat Pothong, Naoya Inoue, Camélia Guerraoui, Wenzhi Wang, Shoichi Naito, Jungmin Choi, Kentaro Inui. [Flee the Flaw: Annotating the Underlying Logic of Fallacious Arguments Through Templates and Slot-filling](https://aclanthology.org/2024.emnlp-main.1142/). In Proceedings of the 2024 Conference on Empirical Methods in Natural Language Processing (EMNLP), pp. 20524–20540, November 2024.

1. Shoichi Naito, Wenzhi Wang, Paul Reisert, Naoya Inoue, Camélia Guerraoui, Kenshi Yamaguchi, Jungmin Choi, Irfan Robbani, Surawat Pothong, Kentaro Inui. [Designing Logic Pattern Templates for Counter-Argument Logical Structure Analysis](https://aclanthology.org/2024.findings-emnlp.661/). In Findings of the 2024 Conference on Empirical Methods in Natural Language Processing (EMNLP), pp. 11313–11331, November 2024.

1. Ai Ishii, Naoya Inoue, Hisami Suzuki and Satoshi Sekine. [Analysis of LLM’s “Spurious” Correct Answers Using Evidence Information of Multi-hop QA Datasets](https://aclanthology.org/2024.kallm-1.3/). In Proceedings of the First Workshop on Knowledge Graphs and Large Language Models (KALLM), pp. 24–34, August 2024.

1. Yuting Shi, Naoya Inoue, Houjing Wei, Yufeng Zhao and Tao JIN. [Find-the-Common: A Benchmark for Explaining Visual Patterns from Images](https://aclanthology.org/2024.lrec-main.642/). In Proceedings of the 2024 Joint International Conference on Computational Linguistics, Language Resources and Evaluation (LREC-COLING2024), pp. 7307-7313, May 2024.

1. Ai Ishii, Naoya Inoue, Hisami Suzuki and Satoshi Sekine. [JEMHopQA: Dataset for Japanese Explainable Multi-Hop Question Answering](https://aclanthology.org/2024.lrec-main.831/). In Proceedings of the 2024 Joint International Conference on Computational Linguistics, Language Resources and Evaluation (LREC-COLING2024), pp. 9515-9525, May 2024.

1. Daichi Haraguchi, Kiyoaki Shirai, Naoya Inoue and Natthawut Kertkeidkachorn. [Discovering Highly Influential Shortcut Reasoning: An Automated Template-Free Approach](https://aclanthology.org/2023.findings-emnlp.424/). In Findings of the 2023 Conference on Empirical Methods in Natural Language Processing (EMNLP2023), pp. 6401-6407, December 2023.

1. Camélia Guerraoui, Paul Reisert, Naoya Inoue, Farjana Sultana Mim, Shoichi Naito, Jungmin Choi, Irfan Robbani, Wenzhi Wang and Kentaro Inui. [Teach Me How to Argue: A Survey on NLP Feedback Systems in Argumentation](https://aclanthology.org/2023.argmining-1.3/). In Proceedings of the 10th Workshop on Argumentation Mining (ArgMining2023), pp. 19-34, December 2023.

1. Hoai Linh Luu and Naoya Inoue. [Counterfactual Adversarial Training for Improving Robustness of Pre-trained Language Models](https://aclanthology.org/2023.paclic-1.88/). In Proceedings of Pacific Asia Conference on Language, Information and Computation (PACLIC37), pp. 881-888, December 2023.
